...
pub mod pallet {
	...
	use frame_support::traits::{tokens::fungibles::Transfer, Currency, Time};
	...
	pub type BalanceOf2<T> = <T as pallet_mapped_assets::Config<()>>::Balance;
	...
	pub trait Config: frame_system::Config + pallet_fruniques::Config {
		...
		type MappedAssets: Transfer<Self::AccountId>;
	}
