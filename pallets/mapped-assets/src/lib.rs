...
impl AssetsCallback<u32, AccountId32> for DefaultCallback {
  fn created(_id: &u32, _owner: &AccountId32) {
    // Empty implementation
  }

  fn destroyed(_id: &u32) {
    // Empty implementation
  }
}
...
pub mod pallet {
  ...
  impl<T: Config<I>, I: 'static> GenesisBuild<T, I> for GenesisConfig<T, I> {
    fn build(&self) {
      ...
      for (id, account_id, amount) in &self.accounts {
        let result =
          <Pallet<T, I>>::increase_balance(*id, account_id, *amount, |details| -> DispatchResult {
            debug_assert!(
  ...
  pub enum Event<T: Config<I>, I: 'static = ()> {
    ...
    ApprovalsDestroyed { asset_id: T::AssetId, approvals_destroyed: u32, approvals_remaining: u32 },
