use hashed_runtime::{
  AccountId, AuraConfig, BalancesConfig, BitcoinVaultsConfig, CouncilConfig, GenesisConfig,
  GrandpaConfig, NodeAuthorizationConfig, Signature, SudoConfig, SystemConfig, WASM_BINARY,
};
  ...
  GenesisConfig {
    ...
    node_authorization: NodeAuthorizationConfig {
      nodes: vec![
        (
          OpaquePeerId(
            bs58::decode("12D3KooWQxwQyQ3BaCs5tweoTmHNWHbpHePZt6P9SscBps1FWsUc")
              .into_vec()
              .unwrap(),
          ),
        ...
        (
          OpaquePeerId(
            bs58::decode("12D3KooWJjJrH549Xa1BW5YizRmF6MKXvUYH2NQkf9HHvg61QXUm")
              .into_vec()
              .unwrap(),
          ),
